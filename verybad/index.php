...
<html>
<head>
	<title>"Студия Ч" - студия ландшафтного дизайна / главная</title>
...
<!-- о студии -->
	...
	<tr valign="top"><td><img src="images/ostudii.gif"><img src="images/topline2.gif"><img src="images/kray2.gif"></td></tr>
	</table>
	<table frame="vsides" width="569" border="2" bordercolor="009900"><tr><td bordercolor="#ffffff">
	"Студия Ч" - это частная организация, занимающаяся проектированием и реализацией обустройства частных земельных участков.
	</td></tr>
	</table>
	<table width="569" cellpadding="0" cellspacing="0">
...
<!-- новости -->
	<table width="569" cellpadding="0" cellspacing="0">
	<tr valign="top"><td><img src="images/news.gif"><img src="images/topline2.gif"><img src="images/kray2.gif"></td></tr>
	</table>
	<table frame="vsides" width="569" border="2" bordercolor="009900"><tr><td bordercolor="#ffffff">
